...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if key_pressed[pygame.K_a]:
            self.image = pygame.image.load(r'left.png').convert()
            self.image.set_colorkey(white)
            self.pos.x -= move_space
            self.flag = 2
        if key_pressed[pygame.K_d]:
            self.image = pygame.image.load(r'right.png').convert()
            self.image.set_colorkey(white)
            self.pos.x += move_space
            self.flag = 1
        if key_pressed[pygame.K_w]:
            self.image = pygame.image.load(r'up.png').convert()
            self.image.set_colorkey(white)
            self.pos.y -= move_space
            self.flag = 3
        if key_pressed[pygame.K_s]:
            self.image = pygame.image.load(r'down.png').convert()
            self.image.set_colorkey(white)
            self.pos.y += move_space
            self.flag = 4
